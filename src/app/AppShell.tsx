...
export function AppShell() {
  ...
  return (
    <div className="min-h-screen bg-[#090e1b] text-slate-100 selection:bg-amber-300 selection:text-slate-950">
      ...
      <main className={view === "home" ? "pt-14 sm:pt-16 md:pt-18" : ""}>
        {view === "home" && (
          <div className="animate-reader-in">
            ...
            <div className="mx-auto grid max-w-[1480px] gap-8 px-4 py-8 sm:gap-10 sm:px-6 sm:py-10 md:grid-cols-[minmax(0,1fr)_280px] md:gap-8 md:px-6 lg:grid-cols-[minmax(0,1fr)_300px] lg:gap-12 lg:px-8 xl:grid-cols-[minmax(0,1fr)_320px] xl:gap-14">
              <div className="space-y-12 sm:space-y-14 md:space-y-16 lg:space-y-16">
                {activeFilter && (
